...
class Dialog(SqlAlchemyBase, UserMixin, SerializerMixin):
    ...
    friend_dialog_id1 = sqlalchemy.Column(sqlalchemy.Integer, sqlalchemy.ForeignKey("users.id"))
    friend_dialog_id2 = sqlalchemy.Column(sqlalchemy.Integer, sqlalchemy.ForeignKey("users.id"))
